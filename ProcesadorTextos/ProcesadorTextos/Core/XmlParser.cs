...
{
	/// <summary>
	/// Parser SAX para transformar un fichero rtf en xml.
	/// </summary>
	public class XmlParser : SarParser
	{
		...
		/// <summary>
		/// Inserta la etiqueta del elemento principal.
		/// </summary>
		...
		/// <summary>
		/// Cierra la etiqueta del elemento principal.
		/// </summary>
